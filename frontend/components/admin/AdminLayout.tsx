...
const BlogIcon = () => <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H15" /></svg>;
...
const KeyIcon = () => <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H5v-2H3v-2H1v-4a6 6 0 016-6h4a6 6 0 016 6z" /></svg>
    ...
    const SidebarContent = () => (
        <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 px-4 py-6 space-y-2">
                ...
                <NavLink to="/admin/blogs" className={navLinkClasses} onClick={() => setSidebarOpen(false)}>
                    <BlogIcon /><span className="ml-3">Blogs</span>
                </NavLink>
